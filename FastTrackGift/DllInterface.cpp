...
FastTrackGiftDll DllInterface::m_the_app;
...
AppID DllInterface::GetAppID()
{
	...
	m_app_id.m_app_id = 66;
#ifdef DATA_COLLECTION_ENABLED
	m_app_id.m_app_name = "FastTrack DC";
	m_app_id.m_version = 0x00000004;
#endif
#ifdef SHARING_ENABLED
#ifdef THROTTLED_DECOYING
	m_app_id.m_app_name = "FastTrack Throttled Decoyer";
	m_app_id.m_version = 0x00000037;
#else
#ifdef FILE_SERVER_ENABLED
	m_app_id.m_app_name = "FastTrack Swarmer";
	m_app_id.m_version = 0x00000036;
#else
	m_app_id.m_app_name = "FastTrack Spoofer";
	m_app_id.m_version = 0x00000036;
#endif
#endif
#endif
