...
void FalseQueryHit::InitTrailer()
{
	...
	memcpy(m_trailer,"MRPH",4);	// say we are Bearshare
#else
...
void FalseQueryHit::InitSwarmTrailer(const char* artist, const char* album, const char* title, int bitrate,int track)
{
