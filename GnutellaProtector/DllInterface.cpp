...
GnutellaProtectorDll DllInterface::m_the_app;
...
AppID DllInterface::GetAppID()
{
	...
	m_app_id.m_app_id = 35;
	m_app_id.m_version = 0x00000071;
#ifdef BEARSHARE_ONLY
	m_app_id.m_app_name = "BearShare Protector";
#else
	m_app_id.m_app_name = "Gnutella Protector";
#endif
	return m_app_id;
}
