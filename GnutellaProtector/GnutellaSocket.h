...
//	GnutellaHostConnectionStatus m_host_connection_status;
	...
	int Swarm(ProjectKeywords *keywords,SupplyProject supply_project,ProjectStatus *status, int track, Query& qu);
	int ClumpSpoof(ProjectKeywords *keywords,SupplyProject supply_project,ProjectStatus *status, int track, Query& qu);
	int Decoy(ProjectKeywords *keywords,SupplyProject supply_project,ProjectStatus *status, int track, Query& qu);
