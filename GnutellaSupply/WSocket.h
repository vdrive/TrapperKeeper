...
//	int SendSocketData(void *buf,unsigned int buf_len);
	...
	virtual void SocketDataSent(unsigned int len)=0;
	virtual void SocketDataReceived(char *data,unsigned int len)=0;
	virtual void SomeSocketDataReceived(char *data,unsigned int data_len,unsigned int new_len,unsigned int max_len)=0;
