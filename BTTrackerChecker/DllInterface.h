...
#include "BTTrackerCheckerDll.h"	//This is your main app class
...
protected:
	static BTTrackerCheckerDll m_the_app; //This is the main class of your application
								   //Change it to your main app class instead of BTTrackerChecker class here
};
