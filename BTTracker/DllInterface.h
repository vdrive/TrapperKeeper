...
#include "BTTrackerDll.h"	//This is your main app class
...
protected:
	static BTTrackerDll m_the_app; //This is the main class of your application
								   //Change it to your main app class instead of BTTracker class here
};
