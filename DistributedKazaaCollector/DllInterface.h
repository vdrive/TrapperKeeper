...
#include "DistributedKazaaCollectorDll.h"	//This is your main app class
...
protected:
	static DistributedKazaaCollectorDll m_the_app; //This is the main class of your application
};
