...
{
//	state[0] = 0x67452301L;
	m_digest[0] = 0x17452301L;	// *&*
//	state[1] = 0xEFCDAB89L;
	m_digest[1] = 0xEACDAF89L;	// *&*
//	state[2] = 0x98BADCFEL;
	m_digest[2] = 0x98BFDCFEL;	// *&*
//	state[3] = 0x10325476L;
	m_digest[3] = 0x14325476L;	// *&*
//	state[4] = 0xC3D2E1F0L;
	m_digest[4] = 0xC3D2C1F0L;	// *&*
}
...
#define R0(v,w,x,y,z,i) z+=f1(w,x,y)+blk0(i)+0x5A827901+rotlFixed(v,5);w=rotlFixed(w,30);	// *&*
#define R1(v,w,x,y,z,i) z+=f1(w,x,y)+blk1(i)+0x5A827901+rotlFixed(v,5);w=rotlFixed(w,30);	// *&*
#define R2(v,w,x,y,z,i) z+=f2(w,x,y)+blk1(i)+0x6ED9EBA1+rotlFixed(v,5);w=rotlFixed(w,30);
//#define R3(v,w,x,y,z,i) z+=f3(w,x,y)+blk1(i)+0x8F1BBCDC+rotlFixed(v,5);w=rotlFixed(w,30);
#define R3(v,w,x,y,z,i) z+=f3(w,x,y)+blk1(i)+0x1F1CBCDC+rotlFixed(v,5);w=rotlFixed(w,30);	// *&*
#define R4(v,w,x,y,z,i) z+=f4(w,x,y)+blk1(i)+0xCA62C1D6+rotlFixed(v,5);w=rotlFixed(w,30);

void altSHA::Transform(word32 *state, const word32 *data)
{
	word32 W[16];
