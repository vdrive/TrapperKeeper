...
#include "MetaMachineHashSetCollectorDll.h"	//This is your main app class
...
protected:
	static MetaMachineHashSetCollectorDll m_the_app; //This is the main class of your application
