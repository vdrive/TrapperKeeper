...
//	void CreateSpoofShares();
	...
	{
#ifdef WINMX_DC
		NumberOfEvents=WSA_MAXIMUM_WAIT_EVENTS-30,
#else
		NumberOfEvents=WSA_MAXIMUM_WAIT_EVENTS,
#endif
		NumberOfReservedEvents=4,
		NumberOfSocketEvents=NumberOfEvents-NumberOfReservedEvents //30 sockets
	};

	WSAEVENT m_events[NumberOfEvents];
	WinMXSocket m_sockets[NumberOfSocketEvents];
...
//	vector<SupplyProject> v_supply;
	...
	*/
	...
	CRITICAL_SECTION m_psq_lock;	//lock for PSQ table
