...
WinMxDcDll DllInterface::m_the_app;
...
#ifdef WINMX_DC
	m_app_id.m_app_id = 1001;
	m_app_id.m_app_name = "WinMx DC";
	m_app_id.m_version = 0x00000001;
#endif
#ifdef WINMX_SPOOFER
	m_app_id.m_app_id = 1002;
	m_app_id.m_app_name = "WinMx Spoofer";
	m_app_id.m_version = 0x00000011;
#endif
#ifdef WINMX_SWARMER
	m_app_id.m_app_id = 1003;
	m_app_id.m_app_name = "WinMx Swarmer";
	m_app_id.m_version = 0x0000000d;
#endif
	return m_app_id;
}
