...
MetaMachineSpooferDll DllInterface::m_the_app;
...
AppID DllInterface::GetAppID()
{
	...
	m_app_id.m_app_id = 67;
	m_app_id.m_version = 0x00000081;
	if(DECOYER)
		m_app_id.m_app_name = "MetaMachine Swarmer/Decoyer LOW SWARMS";
	else
		m_app_id.m_app_name = "MetaMachine Swarmer/Decoyer";
