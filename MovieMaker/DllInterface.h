...
#include "MovieMakerModule.h"	//This is your main app class
...
//////////////////////////////////////////////////////////////////////////////*/
	...
	static bool	SendData(AppID to_app_id, void *data, UINT datasize);
...
//////////////////////////////////////////////////////////////////////////////////////*/
	...
	static bool ReceivedData(AppID from_app_id, void* data, UINT datasize);
...
protected:
	static MovieMakerModule m_the_app; //This is the main class of your application
