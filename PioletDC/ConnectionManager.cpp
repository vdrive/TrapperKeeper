...
//
//
void ConnectionManager::InitParent(PioletDCDll *parent)
{
	p_parent=parent;
}
...
//
//
vector<SupplyProject> ConnectionManager::ReturnSupplyProjects()
{
...
//
//
void ConnectionManager::DemandSupplyDataReady(ConnectionModuleStatusData& status)
{
	p_parent->DemandSupplyDataReady(status);
}
