...
BEGIN_MESSAGE_MAP(ConnectionModuleMessageWnd,CWnd)
	...
	ON_MESSAGE(WM_DEMAND_SUPPLY_DATA_READY,DemandSupplyDataReady)
END_MESSAGE_MAP()
...
//
//
LRESULT ConnectionModuleMessageWnd::DemandSupplyDataReady(WPARAM wparam,LPARAM lparam)
{
	p_mod->DemandSupplyDataReady();
	return 0;
}
