...
int SupplyProject::GetBufferLength()
{
	...
	count += sizeof(m_is_searching);
	count += sizeof(m_last_search_started);
...
//	int i;
	...
	*((bool *)ptr)=m_is_searching;
	ptr+=sizeof(bool);

	*((CTime *)ptr)=m_last_search_started;
	ptr+=sizeof(CTime);
...
//	int i;
	...
	m_is_searching=*((bool *)ptr);
	ptr+=sizeof(bool);

	m_last_search_started=*((CTime *)ptr);
	ptr+=sizeof(CTime);
