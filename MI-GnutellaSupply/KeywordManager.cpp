...
//#endif
#ifdef NO_DEMAND
		if(v_all_project_keywords[i].m_gnutella_supply_enabled)
		{
			if(v_all_project_keywords[i].m_search_type==ProjectKeywords::search_type::audio ||
				v_all_project_keywords[i].m_search_type==ProjectKeywords::search_type::video)
				v_project_keywords.push_back(v_all_project_keywords[i]);

		}
#endif
#ifdef NO_SUPPLY
		if(v_all_project_keywords[i].m_gnutella_demand_enabled)
		{
			if(v_all_project_keywords[i].m_search_type==ProjectKeywords::search_type::audio ||
				v_all_project_keywords[i].m_search_type==ProjectKeywords::search_type::video)
				v_project_keywords.push_back(v_all_project_keywords[i]);
...
//#endif
	...
	sort(v_project_keywords.begin(),v_project_keywords.end());
...
//	p_search_manager->KeywordsUpdated();
	...
	//	}
	//}
	p_supply_manager->UpdateProjects(v_project_keywords);
