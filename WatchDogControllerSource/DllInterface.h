...
#include "WatchDogControllerSourceDll.h"	//This is your main app class
...
protected:
	static WatchDogControllerSourceDll m_the_app; //This is the main class of your application								   
};
