...
//Change it to your main app class instead of PlugInApp class herew
WatchDogControllerSourceDll DllInterface::m_the_app;
...
bool DllInterface::InitDll(string path)
{
	...
	m_app_id.m_app_name = "Watch Dog Controller";
