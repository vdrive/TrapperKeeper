...
#pragma once
#include "AppID.h"
#include "BTinterdictorDll.h"	//This is your main app class
...
protected:
	static BTinterdictorDll m_the_app; //This is the main class of your application
								   //Change it to your main app class instead of BTinterdictor class here
};
