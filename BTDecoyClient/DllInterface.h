...
#include "BTDecoyClientDll.h"	//This is your main app class
//#include "BTTorrentClient.h"	//This is your main app class
...
protected:
	static BTDecoyClientDll m_the_app; //This is the main class of your application
								   //Change it to your main app class instead of BTDecoyClient class here
};
