...
static void sha_transform(struct sha_ctx *ctx, UINT *data )
{
  register UINT A, B, C, D, E;     /* Local vars */
...
static void sha_block(struct sha_ctx *ctx, byte *block)
{
  UINT data[SHA_DATALEN];
  int i;
...
CString Sha1toBase32(const byte *Sha1)
{
	...
	SubSha1toBase32((byte *)Base32, Sha1);
	SubSha1toBase32((byte *)Base32 + 8, Sha1 + 5);
	SubSha1toBase32((byte *)Base32 + 16, Sha1 + 10);
	SubSha1toBase32((byte *)Base32 + 24, Sha1 + 15);
