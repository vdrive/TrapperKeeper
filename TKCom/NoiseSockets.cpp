...
//
//
NoiseSockets::NoiseSockets(HWND hwnd,CCriticalSection *connection_data_critical_section,vector<ConnectionData> *connection_data,HashManager* manager)
{
	p_hash_manager = manager;
	m_hwnd=hwnd;
