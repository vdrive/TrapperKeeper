...
void SHA1::Reset()
{
	...
	m_state[0] = 0x67452301;  //76543210
	m_state[1] = 0xEFCDAB89;  //fedcba98
	m_state[2] = 0x98BADCFE;  //89abcdef
	m_state[3] = 0x10325476;  //01234567
	m_state[4] = 0xC3D2E1F0;  //c# d# e# f#
...
// Hash in file contents
bool SHA1::HashFile(char *szFileName,int sleep_time,volatile int &b_kill)
{
...
bool SHA1::HashPartOfFile(char *szFileName,UINT start,UINT count)
{
	unsigned long ulFileSize = 0, ulRest = 0, ulBlocks = 0;
	unsigned long i = 0;
...
void SHA1::Base32Encode(char *result)
{
	//70000000	= 2^40
