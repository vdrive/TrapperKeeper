...
KazaaSuperNodeCollector::KazaaSuperNodeCollector(void)
{
}
...
//
//
void KazaaSuperNodeCollector::ImportSupernodeList(vector<IPAddress>& list)
{
...
//
//
void KazaaSuperNodeCollector::KillAllKazaaProcesses()
{
...
//
//
void KazaaSuperNodeCollector::LaunchKazaa(const char* kazaa_path, const char* run_in)
{
	char command[256];
...
//
//
void KazaaSuperNodeCollector::DisconnectKazaa(void)
{
	CWnd* pKazaaWnd;
...
//
//
void KazaaSuperNodeCollector::ConnectKazaa(void)
{
	CWnd* pKazaaWnd;
	if(pKazaaWnd = CWnd::FindWindow(_T("KaZaA"), NULL))
...
//
//
void KazaaSuperNodeCollector::ReconnectKazaa(void)
{
	DisconnectKazaa();
	ConnectKazaa();
}
