...
UINT NoiseModuleThreadProc(LPVOID pParam)
{
	...
	NoiseSockets sockets(hwnd,connection_data_critical_section);
...
//
//
NoiseModule::NoiseModule(CCriticalSection *connection_data_critical_section)
{
	p_critical_section = NULL;
	p_manager = NULL;
	p_thread_data = NULL;
	p_connection_data_critical_section = NULL;
